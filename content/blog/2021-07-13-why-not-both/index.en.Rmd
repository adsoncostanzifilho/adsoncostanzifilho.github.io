...
This post is divided in 3 sections: **Creating a function**, **Creating an API** and **Calling an API**. In the first section, you will find a simple function created in R and Python, the second section is about how to transform that functions into APIs, the last one is how we can call/use the APIs.
...
The first step to create an API in Python is to install the `FastAPI` package. On terminal run:
